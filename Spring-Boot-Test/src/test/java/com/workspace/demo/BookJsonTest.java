...
//		asserThat(this.json.write(book).isEqualToJson("/test.json"));
//		asserThat(this.json.write(book).hasJsonPathStringValue("title"));
//		asserThat(this.json.write(book).extractingJsonPathStringValue("title").isEqualTo("테스트");
	}
